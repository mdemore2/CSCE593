...
#include <vector>
#include <memory>
#include "GLViewDefenseDaemon.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewDefenseDaemon > glView( Aftr::GLViewDefenseDaemon::New( args ) );
