...
namespace Aftr
{
      ...
      Active() : thd( [&]()
         {
            while( !this->doneRunning )
            {
               ...
               auto work = this->mq.popMsg(); //What goes wrong using this as the main driver, why - discuss breifly in presentation?
   ...
   public:
      ...
      ActivePlotter( std::function<void( T, Gnuplot& )> w ) : workerFunc{ w }, p( ManagerEnvironmentConfiguration::getGNUPlotBin() )
